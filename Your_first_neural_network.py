...
class TestMethods(unittest.TestCase):
    ...
    def test_train(self):
        ...
        print("weights_hidden_to_output:{}".format(network.weights_hidden_to_output))
        self.assertTrue(np.allclose(network.weights_hidden_to_output, 
                                    np.array([[ 0.37275328], 
                                              [-0.03172939]])))
        print("weights_input_to_hidden:{}".format(network.weights_input_to_hidden))
...
print("Final validation: {}".format(losses['validation'][-1]))
plt.legend()
_ = plt.ylim()
...
# The depth of the network is not deep enough. 
